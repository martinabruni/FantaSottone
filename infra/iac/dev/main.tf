...
resource "azurerm_role_assignment" "kv_admin_current_user" {
  ...
  # Assicurati che il Key Vault esista prima di assegnare il ruolo
...
resource "azurerm_mssql_database" "main" {
  ...
  # Disabilita geo-backup per regioni che non lo supportano
...
resource "azurerm_key_vault_secret" "sql_connection_string" {
  ...
  # IMPORTANTE: aspetta che l'RBAC assignment sia completato
  # altrimenti la creazione del secret fallirà per mancanza di permessi
  depends_on = [
